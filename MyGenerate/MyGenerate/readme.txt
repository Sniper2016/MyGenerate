...
mygenerate是一个纯Java的模板服务框架，适合熟悉java开发的用户，由于代码开源，可以自己拓展定制自己需要的模板，
用于动态生成一些固定格式的代码，脚本等等，区别于org.apache.velocity 这些框架，velocity是使用${} #来定义变量，这就导致不能使用这个框架来生成shell脚本和一些需要用到这些关键字的模板
...
2.代码前缀标记：<@@@@@@
3.代码后缀标记：@@@@@@>
4.MyGenerateHandler里面需要的bean都定义在MyGenerateHandler.java文件里面，通过静态内部类或者私有类，方便编译
